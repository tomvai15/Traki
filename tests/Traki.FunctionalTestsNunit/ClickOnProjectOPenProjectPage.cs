...
{
    [TestFixture]
    public class ClickOnProjectOPenProjectPage
    {
        ...
        [Test]
        public void TheClickOnProjectOPenProjectPageTest()
        {
      ...
      //      driver.Navigate().GoToUrl("https://localhost:3000/home");
            ...
            Assert.AreEqual("Projects", driver.FindElement(By.XPath("//div[@id='root']/div/main/div[2]/div/div/nav/ol/li/p")).Text);
        }
